...
public record FixedSizeStringElement(@JsonDeserialize(using = IntegerDeserializer.class) int size, Charset charset, boolean stopAtNull) implements SchemaElement {
